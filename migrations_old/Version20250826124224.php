...
final class Version20250826124224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE variants (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, price INT DEFAULT NULL, is_default TINYINT(1) DEFAULT NULL, INDEX IDX_B39853E1DE18E50B (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE variants ADD CONSTRAINT FK_B39853E1DE18E50B FOREIGN KEY (product_id) REFERENCES products (id)');
    }
